...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/ytia0661@acfr.usyd.edu.au/PycharmProjects/data/in1k/ImageNet-1K', type=str,
                        help='dataset path')
    parser.add_argument('--output_dir', default='output_dir9',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='output_dir9',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 15 == 2 or epoch + 1 == args.epochs:
            ...
            if misc.is_main_process():
                current_acc1, current_acc5 = linear_probing("./output_dir9/temporary.pth", args)
